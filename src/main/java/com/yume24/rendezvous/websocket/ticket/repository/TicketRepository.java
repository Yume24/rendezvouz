...
public class TicketRepository {
    ...
    private static final Duration ticketExpirationDuration = Duration.ofSeconds(30);

    public Mono<Void> saveTicket(String userId, String ticket) {
        return redisTemplate.opsForValue().set(getKey(userId), ticket, ticketExpirationDuration).then();
    }
